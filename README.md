...
Le Machine Learning n'est pas n'est pas qu'un fantasme futuriste. En fait, il existe depuis plusieurs dizaines d'années dans certaines applications spécialisées, comme le filtre anti-spam.
Si nous voulons écrire un filtre Anti-spam en utilisant la technique de programmation traditionnelle : 
